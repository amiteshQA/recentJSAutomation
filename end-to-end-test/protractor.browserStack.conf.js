...
exports.config = {
    /*This code is to run the scripts in multiple browsers using BrowserStack*/
    ...
    'multiCapabilities': [{
        'build': '3.37.0 Patch release',
        'name': '3.37.0 Patch release 2nd run',
        'project': 'newSpecial',
    ...
    beforeLaunch:function(){
        ...
        log4js.configure({
            appenders: {
                out: { type: 'file', filename: './end-to-end-test/executionLog/executionLogs.log', layout: {
                        type: 'pattern',
